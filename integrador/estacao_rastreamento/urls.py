...
urlpatterns = [
    path("cadastrar/", EstacaoRastreamentoCreateView.as_view(), name="estacao_rastreamento"),
    path("listar/", EstacaoRastreamentoListView.as_view(), name="estacao_rastreamento_list"),
    path("editar/<int:pk>/", EstacaoRastreamentoUpdateView.as_view(), name="edit_estacao_rastreamento"),
