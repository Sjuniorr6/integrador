...
class EstacaoRastreamentoForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "tipo_de_estacao_de_rastreamento": forms.Select(attrs={"class": "form-select"}),
            "Separacao_de_rastreamento": forms.Select(attrs={"class": "form-select"}),
            "Numero_maximo_de_veiculos_da_estacao": forms.NumberInput(attrs={"class": "form-control", "min": 1}),
            "Eventos_sem_tratamento": forms.CheckboxInput(attrs={"class": "form-check-input"}),
            "Mostrar_no_monitor_de_operacoes": forms.CheckboxInput(attrs={"class": "form-check-input"}),
            "Estacao_de_alto_risco": forms.CheckboxInput(attrs={"class": "form-check-input"}),
            "Usar_importancia_do_evento_para_redirecionar": forms.CheckboxInput(attrs={"class": "form-check-input"}),
        }
